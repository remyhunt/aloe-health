  ...
  return (
    <div className="container mx-auto flex justify-between pt-[2.5rem] h-[6rem] px-[2rem]">
      <div className="flex lg:hidden">
        <div
          className="translate-y-[-.4rem] h-max rounded-[5px] border-white border-[1px] p-[.3rem] ">
          Sign up
        </div>
      </div>
      <div className="flex flex-row">
        <span className="text-[2rem] mt-[-13px] mr-[12px]">Aloe</span>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="translate-y-[-1rem] mr-[2rem] fill-black w-[3rem] h-[3rem]">
        ...
        <div id="nav-bar" className=" hidden lg:flex flex-row space-x-[2rem] ">
          ...
          {/* <!-- <div id="dropdown" style="opacity: 0; z-index: 4;"
          className="dropdown-menu">
        
            <div
              className="flex px-[2rem] text-[#333] bg-gray-200 py-[2rem] flex-col justify-between ">
              <div>1</div>
              <div>2</div>
              <div>3</div>
            </div>
            <div
              className="flex text-[#333] px-[2rem] py-[2rem] flex-col justify-between ">
              <div>a</div>
              <div>b</div>
              <div>c</div>
            </div>
          </div> --> */}
          <div className="flex flex-row cursor-pointer">Product
            <svg className="fill-black w-[.8rem] h-[1.4rem] ml-[3px]"
          ...
          <div className="flex flex-row cursor-pointer">Solutions
            <svg className="fill-black w-[.8rem] h-[1.4rem] ml-[3px]"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 448 512">
                {/* <!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --> */}
          ...
          <div className="flex flex-row cursor-pointer">Services
            <svg className="fill-black w-[.8rem] h-[1.4rem] ml-[3px]"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 448 512">
                {/* <!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --> */}
      ...
      <div className="hidden lg:flex flex-row space-x-[1rem] h-full">
        ...
        <div
          className="translate-y-[-.4rem] h-max rounded-full border-[#333] bg-yellow-100 border-[2px] py-[.3rem] px-[.8rem] ">
          Join Today
        </div>
      </div>
      {/* <!-- /nav-right --> */}
